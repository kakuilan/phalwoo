...
class MyServer extends SwooleServer {
    ...
    public function onSwooleRequest($request, $response) {
        ...
        $cls = get_class($this);
        var_dump('onSwooleRequest', $cls);

        $ins1 = self::getInstance();
        $ins2 = SwooleServer::getInstance();
        $cls1 = get_class($ins1);
        $cls2 = get_class($ins2);
        $chk = $ins2 === $ins1;
        var_dump($cls1, $cls2, $chk);


        //坑$this不是外面的MyServer
        //$logg = SwooleServer::getProperty('logger');
        //var_dump('onRequest $this', $this->logger, $logg);
        ...
        $this->afterSwooleResponse($request, $response);

        return $this;
    }


    public function afterSwooleResponse($request, $response) {
        //TODO
